...
public class Main extends javax.swing.JFrame {
        ...
        run = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Method.setTxt(txt);
                    txt.setText("Server Đang hoạt động ...\n");
                    while (true) {
    ...
    private void stopServer() throws Exception {
        int c = JOptionPane.showConfirmDialog(this, "Bạn Có muốn đóng server ?", "Sotop Server", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
    ...
    private void cmdStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdStartActionPerformed
        try {
            int c = JOptionPane.showConfirmDialog(this, "Khởi động lại Server ?", "Start Server", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            if (c == JOptionPane.YES_OPTION) {
                startServer();
            }
        } catch (Exception e) {
